          ...
          <div class="section">
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <h2>Data Guru</h2>
                  <a href="<?php echo site_url('admin/guruAct/add');?>" title="Materi"><button class="btn btn-primary" ><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Tambah Guru</button></a>
                  <div class="row">
                    <div class="col-sm-2">
                      <h4>Show 
                        <select>
                  ...
                  <table class="table table-bordered" style="color:black; background: #d3fffb;" id="dt">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url('admin/guruAct/edit/').$list['id'];?>" title="Edit"><button class="btn btn-warning" ><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a>
